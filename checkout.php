...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>order</h1>
            <p>Checkout your favourite dish!!</p>
    ...
    <div class="checkout-form">
        ...
        <form method="post">
            ...
            <div class="input-field">
                <label>city</label>
                <input type="text" name="city" placeholder="e.g  Winnipeg">
            </div>
            <div class="input-field">
                <label>state</label>
                <input type="text" name="state" placeholder="e.g Winnipeg">
            </div>
            <div class="input-field">
                <label>country</label>
            ...
            <div class="input-field">
                ...
                <input type="text" name="pin" placeholder="e.g A1B C2D">
            </div>
